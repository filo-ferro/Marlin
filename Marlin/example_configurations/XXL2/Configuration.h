...
#define STRING_CONFIG_H_AUTHOR "SHAREBOT XXL2" // Who made the changes.
...
//sharebot NG/XXL steel nozzle
    #define  DEFAULT_Kp 11.28	//official: 11.87
    #define  DEFAULT_Ki 0.40	//official: 0.50
    #define  DEFAULT_Kd 78.71	//official: 70.42 
