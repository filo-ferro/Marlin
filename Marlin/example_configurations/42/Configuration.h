...
// Mendel Parts V9 on 12V
    #define  DEFAULT_Kp 16.54 //old: 12.56
    #define  DEFAULT_Ki 0.81  //old: 0.57
    #define  DEFAULT_Kd 84.53 //old: 68.76
#endif // PIDTEMP
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, argressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 246.43
    #define  DEFAULT_bedKi 14.35
    #define  DEFAULT_bedKd 1057.96
...
#define CUSTOM_M_CODES
  ...
  #define Z_PROBE_OFFSET_RANGE_MIN -10 // -8  
