...
#define STRING_CONFIG_H_AUTHOR "SHAREBOT Q2" // Who made the changes.
...
//sharebot iron nozzle Q   
    #define  DEFAULT_Kp 16.54 //old: 12.07
    #define  DEFAULT_Ki 0.81  //old: 0.43
    #define  DEFAULT_Kd 84.53 //old: 84.05
...
#define HOMING_FEEDRATE {50*100, 50*100, 350, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1600,96.2753}  // default steps per unit for ultimaker
#define DEFAULT_MAX_FEEDRATE          {100, 100, 8, 35}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000,3000,16,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
